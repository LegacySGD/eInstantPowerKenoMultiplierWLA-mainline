...
public class PowerKenoMultiplierWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PowerKenoMultiplierWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/StarshipKenoMultiplierWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/StarshipKenoMultiplierWLAIW/InitOutcome.xml").getDocumentElement();
